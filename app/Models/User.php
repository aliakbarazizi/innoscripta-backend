 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Author> $preferredAuthors
 * @property-read int|null $preferred_authors_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Category> $preferredCategories
 * @property-read int|null $preferred_categories_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Source> $preferredSources
 * @property-read int|null $preferred_sources_count
 *
